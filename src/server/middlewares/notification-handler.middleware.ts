...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Inventory of a certain product is running low.update': {
    roles: ['business-owner', 'storage-manager', 'inventory-clerk'],
    key: 'inventory_low',
    tenantPath: [],
    userPath: [],
  },
  'A new order has been placed by a customer.create': {
    roles: ['business-owner', 'sales-representative'],
    key: 'new_order',
    tenantPath: [],
    userPath: [],
  },
  'Payroll has been updated for the month.update': {
    roles: ['business-owner', 'hr-manager', 'payroll-officer'],
    key: 'payroll_update',
    tenantPath: [],
    userPath: [],
  },
