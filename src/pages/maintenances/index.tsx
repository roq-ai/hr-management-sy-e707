...
export function MaintenanceListPage(props: MaintenanceListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMaintenances({
        relations: ['storage_unit'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['maintenance_type.contains', 'description.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'maintenance_type', header: 'Maintenance Type', accessorKey: 'maintenance_type' },
    { id: 'description', header: 'Description', accessorKey: 'description' },
    { id: 'cost', header: 'cost', accessorKey: 'cost' },
    hasAccess('storage_unit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'storage_unit',
          header: 'Storage Unit',
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/storage-units/view/${record.storage_unit?.id}`}
            >
              {record.storage_unit?.size}
            </Link>
          ),
        }
      : null,
