...
import { getStorageUnitById } from 'apiSdk/storage-units';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('storage_unit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/storage-units/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Unit Number" text={data?.unit_number} />

                <FormListItem label="Size" text={data?.size} />

                <FormListItem label="Availability Status" text={data?.availability_status} />

                <FormListItem label="Rent Price" text={data?.rent_price} />

                <FormListItem
                  label="Last Maintenance Date"
                  text={
                    data?.last_maintenance_date
                      ? format(parseISO(data?.last_maintenance_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
