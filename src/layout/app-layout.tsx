...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Customers', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiBox },
    ...
    { name: 'Payments', path: '/payments', entity: 'payment', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Rentals', path: '/rentals', entity: 'rental', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Securities', path: '/securities', entity: 'security', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
